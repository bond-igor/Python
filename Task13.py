...
# создаем словари для английских и руских букв, где ключ это кол-во очков
eng = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 8:'JZ', 10:'QZ'}
rus = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ', 3:'БГЁЬЯ', 4:'ЙЫ', 5:'ЖЗХЦЧ', 8:'ШЭЮ',
       10:'ФЩЪ'}
# запрашиваем у пользователя слово и переводим все буквы в верхний регистр
word = input('Введите слово: ').upper()
# проходим поочередно по словарям и если буква есть в словаре добавляем её ключ
# к сумме
